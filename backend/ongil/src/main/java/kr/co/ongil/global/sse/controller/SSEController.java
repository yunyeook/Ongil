package kr.co.ongil.global.sse.controller;
...
@Slf4j
@Tag(name = "SSE API", description = "사용자 스트리밍 API")
public class SSEController {
    ...
    @Operation(
        summary = "실시간 스트림 연결 등록",
        description = """
        GPS 위치와 길안내 경로를 실시간으로 수신하기 위한 SSE 연결을 등록합니다.
    ...
    public SseEmitter streamGPS(
        ...
        return SSEService.createEmitter(callerId);
    }
}