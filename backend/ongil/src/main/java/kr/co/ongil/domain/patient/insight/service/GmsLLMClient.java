...
public class GmsLLMClient {
    ...
    /**
     * 시스템 프롬프트 생성 (Few-Shot 예시 + Chain-of-Thought)
     */
    private String buildSystemPrompt() {
        return """
            ...
            **분석 절차 (Chain-of-Thought):**
            다음 단계를 순서대로 따라 신중하게 분석하세요:

            1단계: 데이터 검토
            - 제공된 집계 데이터에서 이전 기간 대비 변화가 큰 지표 3가지를 파악합니다
            - 활성화된 위험 플래그와 심각도 점수를 확인합니다

            2단계: 패턴 인식
            - 여러 지표 간 상관관계를 찾습니다 (예: 수면 부족 + 활동량 감소)
            - 임상 가이드라인을 참고하여 이러한 패턴의 의미를 해석합니다

            3단계: 위험도 평가
            - 각 플래그의 심각도를 종합하여 전체 위험도를 판단합니다
            - 가장 우선적으로 대응해야 할 위험 신호를 2-3가지 선정합니다

            4단계: 보호자 제안 생성
            - 위험도와 상황에 맞는 실천 가능한 구체적 행동을 제안합니다
            - 비약물적 중재를 우선적으로 권장합니다
            - 즉시 실행 가능한 것부터 단계별로 제시합니다

            5단계: JSON 출력
            - 위 분석을 바탕으로 아래 형식에 맞춰 최종 결과를 생성합니다
            ...
            **분석 예시 (Few-Shot Learning):**

            [예시 1: 공간 혼란 고위험 케이스]
            입력:
            - 공간 혼란 플래그: 예 (심각도 8점)
            - 길 잃음 4회, 배회 평균 15분, 야간 배회 2회
            - 전체 위험도: HIGH

            출력:
            {
              "summary": "환자분이 최근 일주일간 익숙한 길에서도 방향을 헷갈려 하는 모습이 자주 관찰되었고, 야간에 집을 나서는 일이 2회 있었습니다. 배회 시간도 평균 15분으로 길어졌습니다.",
              "overall_risk_level": "HIGH",
              "positive_signals": [],
              "warning_signals": [
                "길 잃음이 4회 발생하여 실종 위험이 높습니다",
                "야간 배회가 2회 발생하여 안전사고 위험이 큽니다",
                "배회 시간이 평균 15분으로 이전보다 길어졌습니다"
              ],
              "possible_interpretations": [
                "공간 인지 능력이 저하되어 익숙한 장소에서도 길을 잃고 있습니다",
                "야간 수면 패턴의 변화로 인해 밤에 배회하는 경향이 나타나고 있습니다"
              ],
              "caregiver_suggestions": [
                "현관문에 알림 센서를 설치하여 외출 시 즉시 알림을 받을 수 있도록 합니다",
                "GPS 추적 기기나 배회감지기를 착용시켜 실시간 위치를 확인할 수 있게 합니다",
                "낮 시간에 규칙적으로 함께 산책하여 에너지를 소진시키고 야간 배회를 줄입니다",
                "야간 조명을 켜두어 화장실이나 방을 쉽게 찾을 수 있도록 합니다",
                "경찰서에 사전 지문 등록을 하고, 옷에 인식표를 부착합니다"
              ],
              "data_notes": []
            }
            ...
            [예시 2: 신체 상태 저하 케이스]
            입력:
            - 신체 상태 저하 플래그: 예 (심각도 5점)
            - 평균 수면 5.2시간 (이전 6.8시간), 걸음수 25% 감소
            - 전체 위험도: MEDIUM

            출력:
            {
              "summary": "환자분의 수면 시간이 이전 6.8시간에서 5.2시간으로 줄었고, 걸음수도 25% 감소하여 신체 활동이 전반적으로 줄어든 상태입니다. 수면 부족이 낮 시간 활동에도 영향을 주고 있는 것으로 보입니다.",
              "overall_risk_level": "MEDIUM",
              "positive_signals": [
                "심각한 수준의 건강 이상은 관찰되지 않았습니다"
              ],
              "warning_signals": [
                "수면 시간이 1.6시간 감소하여 권장 수면 시간(7시간)에 미치지 못합니다",
                "걸음수가 25% 감소하여 신체 활동량이 줄어들었습니다"
              ],
              "possible_interpretations": [
                "수면 부족으로 인해 낮 시간 피로감이 증가하여 활동량이 줄어들었을 가능성이 있습니다",
                "신체 기능 저하나 우울감으로 인해 활동 의욕이 감소했을 수 있습니다"
              ],
              "caregiver_suggestions": [
                "매일 같은 시간에 취침하고 기상하도록 규칙적인 수면 일정을 유지합니다",
                "낮 시간에 햇빛을 쬐며 가벼운 산책을 함께 하여 생체리듬을 조절합니다",
                "오후 이후 카페인 섭취를 제한하고, 저녁 시간에는 편안한 활동을 합니다",
                "잠들기 전 따뜻한 우유나 가벼운 스트레칭으로 이완을 돕습니다"
              ],
              "data_notes": []
            }

            **주의사항:**
            - 위 예시를 참고하되, 실제 데이터에 맞춰 구체적으로 작성합니다.
