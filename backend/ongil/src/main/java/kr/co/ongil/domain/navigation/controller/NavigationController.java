...
//    }
//
//    @PostMapping("/{navigationId}/end")
//    @Operation(summary = "길안내 종료", description = "길안내를 종료합니다.")
//    public ResponseEntity<ApiResponse<Void>> endNavigation(
//        @PathVariable String navigationId,
//        @RequestBody @Valid EndNavigationRequest request
//    ) {
//        navigationService.endNavigation(navigationId, request);
//        return ResponseEntity.ok(ApiResponse.success("길안내가 종료되었습니다.", null));
//    }
//
